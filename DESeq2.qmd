...
dds <- DESeqDataSetFromMatrix(countData = reads, colData = df_groups, design = ~ Group)
```
...
#library(edgeR)
htmlwidgets::saveWidget(glimmaMA(dds, groups = colData(dds)$Group), "ma-plot.html")
```

[MA plots](./ma-plot-control-dg1.html)
